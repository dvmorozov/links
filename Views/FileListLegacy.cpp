...
namespace Bookmarks
{
    ...
    void FileListLegacy::PrintScripts()
    {
    ...
    //  https://action.mindjet.com/task/14817423
    void FileListLegacy::PrintStyles()
    {
    }

    void FileListLegacy::PrintHead(std::wstring title)
    {
